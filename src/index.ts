...
// CORS configuration
const corsOptions = {
  origin: ['http://localhost:3000', 'https://clbhoomi.com','https://www.clbhoomi.com'], // Add allowed origins
...
mongoose
  ...
  .then(() => {
    ...
    app.listen(process.env.PORT, () => {
      console.log(`Server running on ports ${process.env.PORT}, I am Satendra`);
    });
  })
